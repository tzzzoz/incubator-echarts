...
function layout(seriesType, ecModel, api) {
  ...
  zrUtil.each(seriesModels, function (seriesModel) {
    ...
    var valueAxisStart = zrUtil.indexOf(baseAxis.getAxesOnZeroOf(), valueAxis) >= 0 || stacked ? valueAxis.toGlobalCoord(valueAxis.dataToCoord(0)) : valueAxis.getGlobalExtent()[0];
